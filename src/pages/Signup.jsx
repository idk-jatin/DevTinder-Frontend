...
export default function Signup() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen w-full overflow-hidden items-center">
      ...
      <div className="flex items-center justify-center w-full lg:w-1/2 bg-[#fefaf6] h-screen px-6 sm:px-10 py-12 md:h-fit md:top-6 lg:top-24 lg:py-0 md:absolute lg:right-1/2 lg:bg-transparent lg:pr-40 md:w-1/2 md:rounded-lg md:bg-opacity-90">
